...
import { Send, User, Bot, AlertTriangle, FileText, CheckCircle2, Moon, Sun, X, Flag } from "lucide-react";
        ...
        <div className="bg-blue-600 dark:bg-slate-900 p-4 text-white flex justify-between items-center transition-colors duration-300">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-blue-200">Nhóm 66 - AI RAG Engine</p>
                </div>
            </div>
          ...
          {messages.map((msg, index) => (
            <div key={index} className={`flex gap-3 max-w-[90%] ${msg.role === 'user' ? 'ml-auto justify-end' : ''}`}>
              ...
              <div className={`p-4 rounded-2xl shadow-sm text-sm w-full ${
                ...
                {/* Báo lỗi button for bot messages */}
                    ...
                    {reportingIdx === index ? (
                      <div className="flex flex-col gap-2 w-full">
                        <input
                          ...
                          placeholder="Mô tả lỗi (VD: sai số ngày phép)..."
                          className="text-xs px-3 py-2 border rounded-lg dark:bg-slate-900 dark:border-slate-600 dark:text-white focus:outline-none focus:ring-1 focus:ring-red-400"
                        />
                        <div className="flex gap-2">
